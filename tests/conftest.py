  ...
  <div class="grid">
    <div class="panel">
      ...
      <svg viewBox="0 0 320 150" role="img" aria-label="導入前後の一次回答時間比較">
        <rect x="28" y="36" width="96" height="72" fill="#d9d9d9"></rect>
        <rect x="180" y="62" width="96" height="46" fill="#8f2f2b"></rect>
        <text x="76" y="28" text-anchor="middle" font-size="13">導入前 19分</text>
        <text x="228" y="54" text-anchor="middle" font-size="13">導入後 11分</text>
        <text x="76" y="128" text-anchor="middle" font-size="12">現行</text>
        <text x="228" y="128" text-anchor="middle" font-size="12">PoC後</text>
      </svg>
    </div>
    <div class="panel">
